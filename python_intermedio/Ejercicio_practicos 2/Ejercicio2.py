...
def es_primo(num):
    ...
    for i in range(2,num-1):
        #si se divide por alguno retornamos false y termina el bucle
        if num%i==0: return False
        #si termina el bucle, significa que no fue divisible entocenes es primo
    return True

#creamos funcion que retorne una lista con todos los primos 
